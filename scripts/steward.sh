...
echo ""
echo "===> Expose the Argo CD service at http://localhost:$ARGO_CD_PORT with this command:"
...
echo ""
echo "===> Check the https://$GITLAB_ENDPOINT/$GITLAB_USERNAME/project-syn-cluster project in GitLab."
echo ""
